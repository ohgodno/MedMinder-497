...
#ifndef COCOATEXTFIELD_SWIFT_H
#define COCOATEXTFIELD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CocoaTextField",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14CocoaTextField14CocoaTextField")
@interface CocoaTextField : UITextField
/// Sets hint color for not focused state
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull inactiveHintColor;
/// Sets hint color for focused state
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull activeHintColor;
