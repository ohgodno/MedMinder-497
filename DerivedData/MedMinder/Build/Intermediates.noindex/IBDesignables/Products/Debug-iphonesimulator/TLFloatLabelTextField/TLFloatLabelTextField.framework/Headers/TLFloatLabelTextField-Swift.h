...
#ifndef TLFLOATLABELTEXTFIELD_SWIFT_H
#define TLFLOATLABELTEXTFIELD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TLFloatLabelTextField",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC21TLFloatLabelTextField21TLFloatLabelTextField")
@interface TLFloatLabelTextField : UITextField
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC21TLFloatLabelTextField20TLFloatLabelTextView")
@interface TLFloatLabelTextView : UITextView
@property (nonatomic, copy) NSString * _Nullable accessibilityLabel;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
